  ...
  return (
    <Layout>
      ...
      <div className="gridContainer">
        ...
        <ProjectCard name="Briefer" description="Chrome Extension that assists people with research by simplifying, summarising, and fusing web pages." tech="HTML, CSS and JS" tryLink="https://briefer.netlify.app"></ProjectCard>  
